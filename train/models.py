...
def prepare_model_settings(label_count, sample_rate, clip_duration_ms,
    ...
    """Returns dictionary of model settings."""
    ...
    if preprocess == 'mfcc':
        ...
        fingerprint_width = (desired_samples - window_size_samples) // window_stride_samples + 1
    elif preprocess == 'micro':
        fingerprint_width = dct_coefficient_count  # for micro frontend
    else:
        raise ValueError('Unknown preprocess type: %s' % preprocess)
